...
# WARNING: Community reports suggest pi0.5 LoRA fine-tuning is unreliable
# (1% success rate in one test). Consider using pi0 LoRA instead.
# See finetune_pi_hyperparameter.md for details.
...
for DATASET in "${DATASETS[@]}"; do
    ...
    echo "=========================================="
    echo "LoRA fine-tuning ${POLICY_TYPE} on: ${DATASET}"
