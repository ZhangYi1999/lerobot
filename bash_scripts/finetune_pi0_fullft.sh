...
# Full fine-tuning with all parameters trainable (including vision encoder)
# GPU: 1x H100-94GB, estimated ~58-63GB VRAM
...
for DATASET in "${DATASETS[@]}"; do
    ...
    echo "=========================================="
    echo "Full FT (all params) ${POLICY_TYPE} on: ${DATASET}"
