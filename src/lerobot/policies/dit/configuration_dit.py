...
class DiTConfig(PreTrainedConfig):
    """Configuration class for DiT flow policy.
    ...
    Args:
        ...
        horizon: DiT-flow model action prediction size as detailed in `DiTPolicy.select_action`.
        n_action_steps: The number of action steps to run in the environment for one invocation of the policy.
            See `DiTPolicy.select_action` for more details.
