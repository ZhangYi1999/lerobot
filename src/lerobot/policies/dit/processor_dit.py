...
def make_dit_pre_post_processors(
    ...
    Follows multi_task_dit's processor pattern with conditional language tokenization.

    The pre-processing pipeline prepares the input data for the model by:
    1. Renaming features.
    2. Adding a batch dimension.
    3. Tokenizing the language task description (if language is enabled).
    ...
    # Conditionally add tokenizer step when language is enabled
